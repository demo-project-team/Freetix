  ...
  return (
    <div className="flex sticky top-0">
      ...
      <div className={`bg-gray-800 text-white w-64 sticky top-0 p-4  md:relative h-screen md:sticky transition-all duration-300 ${open ? 'block' : 'hidden md:block'}`}>
        ...
        <Link href="/vendor" className="block hover:bg-gray-700 p-2 rounded">Home</Link>
        <Link href="/vendor/booking" className='block hover:bg-gray-700 p-2 rounded'>Bookings</Link>
