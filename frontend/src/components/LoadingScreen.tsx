...
import OptimizedParticlesEffect from "./ParticlesBackground";

const LoadingScreen = () => {
  return (
    <StyledWrapper>
      <div className="background-container">
        <OptimizedParticlesEffect />
      </div>
...
const StyledWrapper = styled.div`
  ...
  .ring-3 {
    box-shadow: 0px 0px 10px 15px rgba(255, 255, 255, 0.6);
    border-radius: 50%;
    padding: 2px;
  }

  .ring-2 {
    box-shadow: 0px 0px 2px 10px rgba(0, 0, 0, 0.7);
    border-radius: 50%;
    padding: 2px;
  }
