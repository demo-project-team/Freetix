...
const HomeCaruesel = () => {
  return (
    <Carousel
      className="w-full max-w-7xl h-[500px] overflow-hidden mt-18 rounded-lg"
      plugins={[Autoplay({ delay: 5000 })]}
      style={{ boxShadow: "0 0 10px rgba(255, 255, 255, 0.2)" }}
    >
      <CarouselContent>
        <CarouselItem className="w-full max-w-7xl overflow-hidden flex items-center h-[500px] relative">
          <img
